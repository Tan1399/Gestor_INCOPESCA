...
{
    public partial class AgregarContable : Form
    {
        public AgregarContable()
        {
            InitializeComponent();
        }
        ...
        private void AgregarContable_Load(object sender, EventArgs e)
        {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    lastmaintence = dateTimePicker1.Value;
                }
                else
                {
                ...
                int idnombreagregado = new CN_Agregar().agregar2(objagr, out mensaje);
