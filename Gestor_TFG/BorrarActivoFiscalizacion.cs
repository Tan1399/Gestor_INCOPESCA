...
{
    public partial class BorrarActivoFiscalizacion : Form
    {
        public BorrarActivoFiscalizacion()
        {
            InitializeComponent();
        }
        ...
        private void BorrarActivoFiscalizacion_Load(object sender, EventArgs e)
        {
        ...
        private void btnborrar_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(textBox2.Text) != 0)
            {
                    ...
                    ) == DialogResult.Yes)
                {
                    ...
                    bool respuesta = new CN_Agregar().EliminarDEPFiscal(objagre);
