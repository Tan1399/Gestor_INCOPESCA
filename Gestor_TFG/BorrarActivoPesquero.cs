...
{
    public partial class BorrarActivoPesquero : Form
    {
        public BorrarActivoPesquero()
        {
            InitializeComponent();
        }
        ...
        private void btnborrar_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(textBox2.Text) != 0)
            {
                    ...
                    ) == DialogResult.Yes)
                {
                    ...
                    bool respuesta = new CN_Agregar().EliminarPesquero(objagre);
        ...
        private void BorrarActivoPesquero_Load(object sender, EventArgs e)
        {
