...
{
    public partial class BorrarActivoTi : Form
    {
        public BorrarActivoTi()
        {
            InitializeComponent();
        }
        ...
        private void BorrarActivoTi_Load(object sender, EventArgs e)
        {
        ...
        private void btnborrar_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(textBox2.Text) != 0)
            {
                    ...
                    ) == DialogResult.Yes)
                {
                    ...
                    bool respuesta = new CN_Agregar().ELiminarTI(objagre);
