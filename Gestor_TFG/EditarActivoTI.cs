...
{
    public partial class EditarActivoTI : Form
    {
        public EditarActivoTI()
        {
            InitializeComponent();
        }
      ...
      /*  public void ComboBoxdep() {
            comboBoxdepartamentos.Items.Add("Departamento Contable");
            comboBoxdepartamentos.Items.Add("Departamento Fiscal");
            comboBoxdepartamentos.Items.Add("Departamento Pesquero");
            comboBoxdepartamentos.Items.Add("Departamento Promocion");
            comboBoxdepartamentos.Items.Add("Departamento Recursos");
            comboBoxdepartamentos.Items.Add("Departamento Area");
        ...
        private void EditarActivoTI_Load(object sender, EventArgs e)
        {
...

        {
          ...
          //  HandleDepartmentChange();
            ...
            ((OpcionCombo)cbotraslado.SelectedItem).Text.ToString(), fechaPicker1Valor,textBox7.Text,((OpcionCombo)cbomaintence.SelectedItem).Text.ToString(), fechaPicker1Valor2});
                ...
                {
                    bool resultado = new CN_Agregar().EditarTI(objagr, out mensaje);
                    if (resultado)
                    {
      ...
      /*  private void HandleDepartmentChange() {
        string mensaje = string.Empty;
            string selectedDepartment = comboBoxdepartamentos.SelectedItem?.ToString();
            if (selectedDepartment=="Departamento Contable") {

                int resultado = new CN_Agregar().Detiacontable(out mensaje);
        ...
        /*  private void comboBoxdepartamentos_SelectedIndexChanged(object sender, EventArgs e)
          {
              ...
              var selectedItem = comboBoxdepartamentos.SelectedItem;
