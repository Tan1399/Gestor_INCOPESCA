...
{
    public partial class EditarFiscalizacion : Form
    {
        public EditarFiscalizacion()
        {
            InitializeComponent();
        }
        public void volver()
        ...
        private void btneditar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (objagr.Iduser == 0)
                {
                    ...
                    int idnombreagregado = new CN_Agregar().agregar7(objagr, out mensaje);
            ...
            ((OpcionCombo)cbotraslado.SelectedItem).Text.ToString(), fechaPicker1Valor,textBox7.Text,((OpcionCombo)cbomaintence.SelectedItem).Text.ToString(), fechaPicker1Valor2});
                ...
                {
                    bool resultado = new CN_Agregar().EditarDEPFiscal(objagr, out mensaje);
                    if (resultado)
                    {
        ...
        private void EditarFiscalizacion_Load(object sender, EventArgs e)
        {
            ...
            List<agregar> agregars = new CN_Agregar().ListarDEPFiscal();
