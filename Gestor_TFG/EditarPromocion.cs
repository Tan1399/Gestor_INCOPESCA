...
namespace Gestor_TFG
{
    public partial class EditarPromocion : Form
    {
        ...
        private void EditarPromocion_Load(object sender, EventArgs e)
        {
        ...
        private void btneditar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (objagr.Iduser == 0)
                {
                    ...
                    int idnombreagregado = new CN_Agregar().agregar5(objagr, out mensaje);
            ...
            ((OpcionCombo)cbotraslado.SelectedItem).Text.ToString(), fechaPicker1Valor,textBox7.Text,((OpcionCombo)cbomaintence.SelectedItem).Text.ToString(), fechaPicker1Valor2});
                ...
                {
                    bool resultado = new CN_Agregar().EditarPromoción(objagr, out mensaje);
                    if (resultado)
                    {
